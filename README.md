...
| **Versión** | **Fecha**  | **Autor**                         | **Descripción**                                                                                                   |
|--------------|------------|-----------------------------------|-------------------------------------------------------------------------------------------------------------------|
| **#03 - TP** | 13/10/25  | **Carlos Jesús Onofre Ruiz**      | Desarrollo del Sprint 3, documentación del acta de reuniones, participación en Daily Scrum, Retrospective y Review. |
| **#03 - TP** | 13/10/25  | **Favio Sebastián Landeo Simeón** | Desarrollo de Student Outcomes, implementación de user stories del backend y correcciones lógicas en el backend. |
| **#03 - TP** | 13/10/25  | **Luis Ángel Anampa Lavado**      | Desarrollo del Sprint 3, pruebas de las aplicaciones (testing) y despliegue de la aplicación backend. |
| **#03 - TP** | 13/10/25  | **Abraham Israel Ayquipa Ubaldo** | Desarrollo de Student Outcomes, módulo de pagos (payments) y user stories del frontend del Sprint 3. |
...
| **Versión** | **Fecha**  | **Autor**                         | **Descripción**                                                                                                   |
|--------------|------------|-----------------------------------|-------------------------------------------------------------------------------------------------------------------|
| **#04 - TB3** | 08/11/25  | **Carlos Jesús Onofre Ruiz**      | Desarrollo del Sprint 4, documentación del acta de reuniones, participación en Daily Scrum, Retrospective y Review. |
| **#04 - TB3** | 08/11/25  | **Favio Sebastián Landeo Simeón** | Desarrollo de Student Outcomes, implementación de user stories del backend y correcciones lógicas en el backend. |
| **#04 - TB3** | 08/11/25  | **Luis Ángel Anampa Lavado**      | Desarrollo del Sprint 4, pruebas de las aplicaciones (testing) y despliegue de la aplicación backend. |
| **#04 - TB3** | 08/11/25  | **Abraham Israel Ayquipa Ubaldo** | Desarrollo de Student Outcomes, módulo de pagos (payments) y user stories del frontend del Sprint 4. |

__TB4__

Para el desarrollo de la entrega **TB4**, se optó por dividir el trabajo de la siguiente forma:

| **Versión** | **Fecha**  | **Autor**                         | **Descripción**                                                                                                   |
|--------------|------------|-----------------------------------|-------------------------------------------------------------------------------------------------------------------|
| **#05 - TB4** | 18/11/25  | **Carlos Jesús Onofre Ruiz**      | Desarrollo del Sprint 5, documentación del acta de reuniones, participación en Daily Scrum, Retrospective y Review. |
| **#05 - TB4** | 18/11/25  | **Favio Sebastián Landeo Simeón** | Desarrollo de Student Outcomes, implementación de user stories del backend y correcciones lógicas en el backend. |
| **#05 - TB4** | 18/11/25  | **Luis Ángel Anampa Lavado**      | Desarrollo del Sprint 5, pruebas de las aplicaciones (testing) y despliegue de la aplicación backend. |
| **#05 - TB4** | 18/11/25  | **Abraham Israel Ayquipa Ubaldo** | Desarrollo de Student Outcomes, módulo de pagos (payments) y user stories del frontend del Sprint 5. |
...
| **Versión** | **Fecha**  | **Autor**                         | **Descripción**                                                                                                   |
|--------------|------------|-----------------------------------|-------------------------------------------------------------------------------------------------------------------|
| **#06 - TF** | 02/12/25  | **Carlos Jesús Onofre Ruiz**      | Desarrollo del Sprint 6, documentación del acta de reuniones, participación en Daily Scrum, Retrospective y Review. |
| **#06 - TF** | 02/12/25  | **Favio Sebastián Landeo Simeón** | Desarrollo de Student Outcomes, implementación de user stories del backend y correcciones lógicas en el backend. |
| **#06 - TF** | 02/12/25  | **Luis Ángel Anampa Lavado**      | Desarrollo del Sprint 6, pruebas de las aplicaciones (testing) y despliegue de la aplicación backend. |
| **#06 - TF** | 02/12/25  | **Abraham Israel Ayquipa Ubaldo** | Desarrollo de Student Outcomes, módulo de pagos (payments) y user stories del frontend del Sprint 6. |
...
- [**Capítulo V: Product Implementation, Validation \& Deployment.**](#capítulo-v-product-implementation-validation--deployment)
  ...
  - [**5.2.1.9 Actas de Reunión.**](#5219-actas-de-reunión)
    ...
    - [**5.2.5. Sprint 5.**](#525-sprint-5)
      - [**5.2.5.1. Sprint Planning 5.**](#5251-sprint-planning-5)
      - [**5.2.5.2. Sprint Backlog 5.**](#5252-sprint-backlog-5)
      - [**5.2.5.3. Development Evidence for Sprint Review.**](#5253-development-evidence-for-sprint-review)
      - [**5.2.5.4. Testing Suite Evidence for Sprint Review.**](#5254-testing-suite-evidence-for-sprint-review)
      - [**5.2.5.5. Execution Evidence for Sprint Review.**](#5255-execution-evidence-for-sprint-review)
      - [**5.2.5.6. Services Documentation Evidence for Sprint Review.**](#5256-services-documentation-evidence-for-sprint-review)
      - [**5.2.5.7. Software Deployment Evidence for Sprint Review.**](#5257-software-deployment-evidence-for-sprint-review)
      - [**5.2.5.8. Team Collaboration Insights during Sprint.**](#5258-team-collaboration-insights-during-sprint)
    - [**5.2.6. Sprint 6.**](#526-sprint-6)
      - [**5.2.6.1. Sprint Planning 6.**](#5261-sprint-planning-6)
      - [**5.2.6.2. Sprint Backlog 6.**](#5262-sprint-backlog-6)
      - [**5.2.6.3. Development Evidence for Sprint Review.**](#5263-development-evidence-for-sprint-review)
      - [**5.2.6.4. Testing Suite Evidence for Sprint Review.**](#5264-testing-suite-evidence-for-sprint-review)
      - [**5.2.6.5. Execution Evidence for Sprint Review.**](#5265-execution-evidence-for-sprint-review)
      - [**5.2.6.6. Services Documentation Evidence for Sprint Review.**](#5266-services-documentation-evidence-for-sprint-review)
      - [**5.2.6.7. Software Deployment Evidence for Sprint Review.**](#5267-software-deployment-evidence-for-sprint-review)
      - [**5.2.6.8. Team Collaboration Insights during Sprint.**](#5268-team-collaboration-insights-during-sprint)
...
|----------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| --- |
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.**   | **Anampa Lavado Luis Angel**, <br><br>**TB1**: Como integrante del equipo, he promovido un ambiente colaborativo en este proyecto, asegurando que mis aportes sean comunicados de manera efectiva. Durante nuestras reuniones, hemos interactuado de manera activa para evaluar el progreso y resolver dudas o consultas que puedan surgir, fomentando así un espíritu de cooperación y aprendizaje mutuo.<br><br>**TB2**: Como integrante he comunicado mis dudas y feedback para los puntos del sprint 2. Durante nuestras reuniones hemos interactuado y planeado lo que se iba encargar cada uno.<br><br>**TP**: Participé en la presentación del Sprint 3, explicando las pruebas automatizadas y el despliegue continuo. Comuniqué los resultados de las pruebas de carga y seguridad a los stakeholders.<br><br>**TB3**: Expuse los avances del Sprint 4, detallando la integración con Google Calendar y las pruebas de exportación de datos. Respondí preguntas técnicas sobre la arquitectura de pruebas.<br><br>**TB4**: Presenté las mejoras de seguridad del Sprint 5, incluyendo el validador de contraseñas. Expliqué el impacto de estas medidas en la protección de datos del usuario.<br><br>**TF**: En la presentación final, demostré el funcionamiento del sistema de calificación y el chat en tiempo real. Resumí los logros técnicos del proyecto y las lecciones aprendidas.<br><br> **Ayquipa Ubaldo, Abraham Israel** <br><br> **TB1**: Comunicó ideas y resultados de manera objetiva a audiencias variadas, compartiendo el progreso y los desafíos del proyecto.**TB2**: Durante el proyecto, presenté con claridad los avances del frontend, especialmente la integración de Stripe. Expliqué el despliegue y respondí preguntas técnicas ante distintos públicos. Mi comunicación fue objetiva y adaptada al nivel de cada interlocutor.<br><br>**TP**: Presenté la implementación del tour interactivo y la gestión de roles en el frontend. Expliqué cómo estas características mejoran la experiencia del usuario.<br><br>**TB3**: Demostré la funcionalidad de sincronización con Google Calendar y la exportación a Excel. Comuniqué los desafíos de integración y cómo se resolvieron.<br><br>**TB4**: Expliqué la implementación del previsualizador de imágenes y las validaciones visuales de seguridad. Destaqué la importancia de la retroalimentación visual para el usuario.<br><br>**TF**: Presenté la interfaz de chat y el sistema de calificación. Expliqué cómo se diseñaron para ser intuitivos y accesibles para todos los usuarios.<br><br>**Onofre Ruiz, Carlos Jesus** <br><br> **TB1**: Entrevistó usuarios y realizó sprints backlog, contribuyendo al desarrollo de la landing page. <br><br>**TB2**: Durante el segundo Sprint del proyecto, demostré habilidades para comunicar mis ideas y resultados de manera oral con objetividad y claridad ante públicos de distintas especialidades y niveles jerárquicos. Participé activamente en la planificación del Sprint, proponiendo soluciones técnicas y organizativas que facilitaron la distribución de tareas. En las sesiones de revisión, presenté los avances del desarrollo, las pruebas realizadas y la ejecución del software, adaptando el lenguaje según el perfil técnico o administrativo de los asistentes. Además, en los espacios de colaboración del equipo, contribuí a la toma de decisiones mediante una comunicación clara, respetuosa y orientada a los objetivos comunes. <br><br>**TP**: Como Scrum Master, facilité las reuniones de Sprint 3 y presenté el progreso del equipo. Comuniqué los impedimentos y las soluciones propuestas.<br><br>**TB3**: Presenté el informe de Sprint 4, destacando el cumplimiento de los objetivos y la velocidad del equipo. Expliqué las métricas de rendimiento y calidad.<br><br>**TB4**: Expuse los resultados del Sprint 5, enfocándome en las mejoras de seguridad y eficiencia. Comuniqué los planes para el sprint final y el cierre del proyecto.<br><br>**TF**: Lideré la presentación final del proyecto, resumiendo el viaje del equipo desde la concepción hasta el producto final. Destaqué el valor entregado al cliente y la calidad del software.<br><br> **Landeo Simeón, Favio Sebastián** <br><br> **TB1**: Informó sobre el progreso y los obstáculos del proyecto a públicos especializados.<br><br>**TB2**: Comuniqué correctamente mis ideas sobre el modelado del Backend y las entidades que deberían estar presentes o no dentro de la lógica de negocio correspondiente, logrando un Backend no recargado y entendible.<br><br>**TP**: Expliqué la arquitectura de notificaciones y el servicio de correo en el Sprint 3. Detallé cómo se integran con otros servicios del backend.<br><br>**TB3**: Presenté la implementación de Redis y Rate Limiting en el Sprint 4. Expliqué cómo estas tecnologías mejoran la escalabilidad y seguridad del sistema.<br><br>**TB4**: Expuse la optimización de endpoints y los filtros avanzados en el Sprint 5. Comuniqué los beneficios en términos de rendimiento y experiencia de usuario.<br><br>**TF**: Presenté la arquitectura de WebSockets para el chat y el sistema de calificación. Expliqué cómo se garantiza la consistencia y disponibilidad de los datos.<br><br> | **General**: La comunicación clara y precisa fue crucial para el éxito del proyecto, facilitando la cooperación y comprensión entre los equipos. La capacidad de comunicar de manera objetiva y profesional coordinó esfuerzos y mejoró la ejecución del proyecto. |
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Anampa Lavado Luis Angel**, <br><br>**TB1**: Como miembro del equipo, cumplí con mis responsabilidades de manera oportuna, asumiendo la tarea de realizar entrevistas, redactar la introducción y el planteamiento del problema, así como contribuir en la elaboración de la landing page en conjunto con mis compañeros. Esta experiencia ha fortalecido nuestras dinámicas de trabajo y ha permitido un desarrollo cohesivo del proyecto.<br><br>**TB2**: Como miembro me he comunicado con el equipo tras finalizar cada tarea asignada con el scrum master, y plantear mejoras posibles para nuevas features.<br><br>**TP**: Documenté los planes de prueba y los resultados de las pruebas automatizadas del Sprint 3. Redacté informes de incidencias claros y concisos.<br><br>**TB3**: Elaboré la documentación técnica de las pruebas de integración con Google Calendar. Redacté guías de usuario para la exportación de datos.<br><br>**TB4**: Documenté las políticas de seguridad y las pruebas de validación de contraseñas. Creé informes de auditoría de seguridad.<br><br>**TF**: Redacté el informe final de pruebas y la documentación de despliegue. Contribuí a la elaboración del manual de usuario y la documentación del proyecto.<br><br> **Ayquipa Ubaldo, Abraham Israel** <br><br> **TB1**: Usó el Lean UX Canvas e intervino en el diseño de la Information Architecture y la estructura de la base de datos. **TB2**: Documenté las funciones del frontend y el uso de Stripe con lenguaje claro y técnico. Redacté informes comprensibles para diversos perfiles, contribuyendo a la presentación escrita del proyecto con precisión y orden. <br><br>**TP**: Documenté la implementación del tour interactivo y la gestión de roles. Redacté especificaciones técnicas para el equipo de desarrollo.<br><br>**TB3**: Elaboré la documentación de la integración con Google Calendar en el frontend. Redacté tutoriales para los usuarios sobre cómo sincronizar sus cuentas.<br><br>**TB4**: Documenté los componentes de UI para la previsualización de imágenes. Redacté guías de estilo para mantener la consistencia visual.<br><br>**TF**: Contribuí a la documentación final del frontend, incluyendo la arquitectura de componentes y el flujo de usuario. Redacté el manual de usuario para el chat y el sistema de calificación.<br><br> **Onofre Ruiz, Carlos Jesus** <br><br> **TB1**: Entrevistó usuarios y participó en el desarrollo de la landing page. <br><br>**TB2**: Redacté documentación técnica del Sprint, incluyendo backlog, evidencias de desarrollo, pruebas, ejecución y despliegue. Usé un lenguaje claro y estructurado, adecuado para distintos perfiles dentro del proyecto de ingeniería. <br><br>**TP**: Como Scrum Master, mantuve actualizado el backlog y documenté las actas de las reuniones. Redacté informes de progreso para los stakeholders.<br><br>**TB3**: Documenté las métricas del Sprint 4 y los resultados de la retrospectiva. Elaboré informes de estado del proyecto.<br><br>**TB4**: Redacté la documentación del Sprint 5, incluyendo los cambios en el alcance y los riesgos identificados. Mantuve la documentación del proyecto actualizada.<br><br>**TF**: Coordiné la redacción del informe final del proyecto. Revisé y edité la documentación técnica y de usuario para asegurar su calidad y coherencia.<br><br> **Landeo Simeón, Favio Sebastián** <br><br> **TB1**: Contribuyó en diversas etapas del desarrollo, creando user personas y empathy maps. <br><br>**TB2**: Contribui a reestructurar los bounded context para aplicar nuevas clases, funcionalidades y entidades. <br><br>**TP**: Documenté la API de notificaciones y el servicio de correo. Redacté especificaciones de interfaz para el equipo de frontend.<br><br>**TB3**: Elaboré la documentación técnica de la implementación de Redis y Rate Limiting. Redacté guías de configuración para el despliegue.<br><br>**TB4**: Documenté los nuevos endpoints y los filtros avanzados. Actualicé la documentación de la API en Swagger.<br><br>**TF**: Redacté la documentación final de la arquitectura del backend. Contribuí a la elaboración del manual técnico y la documentación de mantenimiento.<br><br> | **General**: La documentación clara y detallada fue fundamental para el desarrollo del proyecto, asegurando que toda la información fuera comprensible para los diversos públicos. La escritura objetiva y profesional facilitó la colaboración y el éxito en cada fase del desarrollo. |
...
| **Módulo / Feature**                    | **Evidencia**                                               | **Descripción del Desarrollo**                                                                                                                                                                   |
| --------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Gestión de Sesiones y Seguridad (Redis y Rate Limiting) | <img src="redis.jpeg"> | Se configuró Redis para el manejo de sesiones y tokens de refresco, mejorando la autenticación y el rendimiento general. Además, se implementó el Rate Limiting para limitar las solicitudes por usuario o IP, protegiendo el sistema ante posibles abusos. |
| Integración con Google Calendar | <img src="/calendar.jpeg"> | Se desarrolló la integración con Google Calendar mediante la API y el uso de OAuth 2.0, permitiendo sincronizar automáticamente las reservas de los usuarios. También se añadió una interfaz visual para facilitar la vinculación de cuentas y la gestión de eventos. |
| Exportación de Reservas a Excel | <img src="excel.jpeg"> | Se implementó la exportación de reservas a formato Excel, tanto a nivel de backend como en la interfaz del usuario, donde se agregó un botón para descargar los datos filtrados. |
| Historial de Rutas Consultadas | <img src="/history-reserv.jpeg"> | Se incorporó un historial de rutas consultadas que registra las rutas más utilizadas, permitiendo una visualización dinámica y mejorando la experiencia de uso.|
